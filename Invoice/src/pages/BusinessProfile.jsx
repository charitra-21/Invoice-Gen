                ...
                <div className={businessProfileStyles.cardContainer}>
                    ...
                    <div className={businessProfileStyles.gridCols2}>
                        <div>
                            ...
                            <input className={businessProfileStyles.input} value={meta.businessName || ""} onChange={(e)=>updateMeta("businessName",e.target.value)}
                        ...
                        <div>
                            ...
                            <input className={businessProfileStyles.input} value={meta.email || ""} onChange={(e)=>updateMeta("email",e.target.value)}
                        ...
                        <div>
                            ...
                            <textarea rows={4}
                            className={businessProfileStyles.textarea} value={meta.address || ""} onChange={(e)=>updateMeta("address",e.target.value)}
                        ...
                        <div>
                            ...
                            <input className={businessProfileStyles.input} value={meta.phone || ""} onChange={(e)=>updateMeta("phone",e.target.value)}
                        ...
                        <div>
                            ...
                            <input className={businessProfileStyles.input} value={meta.gst || ""} onChange={(e)=>updateMeta("gst",e.target.value)}
                            placeholder='2ZAAAPL1234C1ZV' />
                        </div>
                    </div>
                </div>
                <div className={businessProfileStyles.cardContainer}>
                    <div className={businessProfileStyles.cardHeaderContainer}>
                        <div className={`${businessProfileStyles.cardContainer} ${iconColors.branding}`}>
              ...
              <div>
                ...
                <div className={businessProfileStyles.uploadArea}>
                  {previews.logo ? (
                    ...
                    <div className='space-y-6'>
                        <div>
                            <h3 className='text-lg font-motion text-gray-900 mb-4'>
                                Tax Settings
                            </h3>
                            <div className={businessProfileStyles.taxContainer}>
                                ...
                                <p className={businessProfileStyles.taxHelpText}>
                                    This tax rate will prefill in new invoices. You can adjust it per invoices as needed.
                                </p>
                            </div>
                        </div>
                    </div>
