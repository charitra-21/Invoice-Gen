      ...
      <div className={appShellStyles.layout}>
        <aside className={`${appShellStyles.sidebar} ${collapsed ? appShellStyles.sidebarCollapsed : appShellStyles.sidebarExpanded}`}>
          ...
          <div className={appShellStyles.sidebarContainer}>
            <div>
              <div className={`${appShellStyles.logoContainer} ${collapsed ? appShellStyles.logoCollapsed : ""}`}>
                <Link to='/' className={appShellStyles.logoLink}>
                  ...
                  {!collapsed && (
                    <div className={appShellStyles.logoTextContainer}>
                      ...
                      <div className={appShellStyles.logoTextUnderline}></div>
                    </div>
                  )}
                </Link>
                {!collapsed && (
                  <button className={appShellStyles.collapseButton} onClick={toggleSidebar}>
              ...
              <div className={`${appShellStyles.userDivider} ${collapsed ? appShellStyles.userDividerCollapsed : appShellStyles.userDividerExpanded}`}>
                {!collapsed ? (
                  <button onClick={logout} className={appShellStyles.logoutButton}>
                    <LogoutIcon className={appShellStyles.logoutIcon}></LogoutIcon>
                    <span>Logout</span>
                  </button>
                ) : (
            ...
            <div className={appShellStyles.mobileSidebar}>
              <div className={appShellStyles.mobileHeader}>
                <Link to='/' className={appShellStyles.mobileLogoLink} onClick={() => setMobileOpen(false)}>
                  ...
                  <span className={appShellStyles.mobileLogoText}>Invoice AI</span>
                </Link>
              ...
              <div className={appShellStyles.mobileLogoutSection}>
                <button onClick={()=>{
                  setMobileOpen(false);
                  logout();
                }} className={appShellStyles.mobileLogoutButton}> <LogoutIcon /> Logout</button>
              </div>
            </div>
          </div>
        )}
          ...
          <header className={`${appShellStyles.header} ${scrolled ? appShellStyles.headerScrolled : appShellStyles.headerNotScrolled}`}>
            ...
            <div className={appShellStyles.headerContent}>
              ...
              <div className={appShellStyles.welcomeContainer}>
                <h2 className={appShellStyles.welcomeTitle}>Welcome Back,{" "}
                  <span className={appShellStyles.welcomeName}>{firstName()}</span>
                </h2>
                <p className={appShellStyles.welcomeSubtitle}>You're all set to go!</p>
              </div>
            </div>
            </div>
